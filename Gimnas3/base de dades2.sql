...
--
-- Host: 127.0.0.1    Database: projecte2dam
-- ------------------------------------------------------
...
INSERT INTO `alt_baix` VALUES (5,'35580886R','2022-03-08',NULL),(6,'',NULL,'2022-03-10'),(7,'64171237H','2022-03-10',NULL);
...
INSERT INTO `historial` VALUES (1),(2),(3),(4),(5),(6),(7);
...
INSERT INTO `registrencolect` VALUES ('87095019K',3,'2022-03-10','2022-03-08');
...
INSERT INTO `registrenindv` VALUES ('89045018L',6,'2022-03-10','2022-03-08'),('87095019K',7,'2022-03-10','2022-03-08');
...
/*!50003 DROP PROCEDURE IF EXISTS `baixaClient` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
and sales.id = activitats.id_sala and (registrencolect.data_act = (curdate()) or registrencolect.data_act = DATE_SUB((curdate()), interval 1 day)) group by activitats.id 
union
...
and sales.id = activitats.id_sala and (registrenindv.data_act = (curdate()) or registrenindv.data_act = DATE_SUB((curdate()), interval 1 day)) group by activitats.id) a
...
-- Dump completed on 2022-03-10 16:51:22
