...
public class Client {
    ...
    public void baixaClient() throws SQLException {
        ...
        CallableStatement SQL = connexioBD.prepareCall("{call baixaClient(?)}");
        System.out.println("Fica el dni del client per fer la baixa");
        String dniBaix = sc.nextLine();
        SQL.setString(1, dniBaix);
        SQL.executeUpdate();
